       ...
       signup.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               if (pwd.equals(cpwd)) {
                   ...
                   if (val > 0) {
                       Intent signIntent = new Intent(AdminRegistration.this, MainActivity.class);
                   ...
                   Toast.makeText(AdminRegistration.this, "username or password not match", Toast.LENGTH_SHORT).show();
               }
           }
